import random
class Human:
    def __init__(self,name='Human', job=None, home=None, car=None, plant=None):
        self.name=name
        self.money=100
        self.gladness=50
        self.satiety=50
...
homer_simpson=Human(name='Homer Simpson')
for day in range(1,8):
    if homer_simpson.live(day)==False:
        break